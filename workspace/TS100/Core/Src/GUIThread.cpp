...
static void gui_solderingTempAdjust() {
  ...
  for (;;) {
    ...
    else OLED::print(systemSettings.ReverseButtonTempChangeEnabled ? SymbolMinus:SymbolPlus);
    ...
    else OLED::print(systemSettings.ReverseButtonTempChangeEnabled ? SymbolPlus:SymbolMinus);
